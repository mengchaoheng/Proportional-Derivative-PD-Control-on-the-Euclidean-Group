...
\paperhead{Lemma 1.}{(Exponential Map) Given $\widehat\psi\in\so(3)$ and $X=(\widehat\psi,p)\in\se(3)$,}{lem:exp-map}
\begin{align*}
...
\begin{equation*}
\tau=-k_p\log(g)-K_d\omega^b\tag{7}\label{eq:7}
\end{equation*}
