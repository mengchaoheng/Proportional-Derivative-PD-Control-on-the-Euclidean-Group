...
\end{align*}
The last term can be upper bounded by $\eps\langle V,V\rangle$ using Lemma~\ref{lem:exponential-map}1 in Appendix B, so that
\begin{equation*}
