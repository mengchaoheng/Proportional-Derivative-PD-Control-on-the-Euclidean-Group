...
\begin{revision}
Define the basis-free inverse differentials
\begin{align*}
\JopR^{-1}(X)
...
\end{align*}
For $x=X^\vee$ and $u\in\R^n$, their coordinate matrices are characterized by
\begin{align*}
\JR^{-1}(x)u
&:=\bigl(\JopR^{-1}(X)(u^\wedge)\bigr)^\vee,\\
\JL^{-1}(x)u
&:=\bigl(\JopL^{-1}(X)(u^\wedge)\bigr)^\vee.
\end{align*}
so that
\begin{align*}
